...
t1=np.concatenate((np.random.normal(2.9, sigma, size2), np.random.normal(3.8, sigma, size2), np.random.normal(1.7, sigma, size2),np.random.normal(5, sigma, size2)))
t2=np.concatenate((np.random.normal(3.95, sigma, size2), np.random.normal(1.7, sigma, size2), np.random.normal(5.2, sigma, size2),np.random.normal(4.8, sigma, size2)))
at1=np.concatenate((np.random.normal(3, sigma, size2), np.random.normal(4, sigma, size2), np.random.normal(2, sigma, size2),np.random.normal(5, sigma, size2)))
at2=np.concatenate((np.random.normal(4, sigma, size2), np.random.normal(1.6, sigma, size2), np.random.normal(5, sigma, size2),np.random.normal(5, sigma, size2)))
